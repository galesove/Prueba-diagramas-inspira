...
public class DGM049 {
	...
	private List<DGM049Detalle> dgm049detalles = new ArrayList<DGM049Detalle>();
	
	public Integer getDgm049Id() {
		return dgm049Id;
	}
	public void setDgm049Id(Integer dgm049Id) {
	...
	public List<DGM049Detalle> getDgm049detalles() {
		return dgm049detalles;
	}
	public void setDgm049detalles(List<DGM049Detalle> dgm049detalles) {
		this.dgm049detalles = dgm049detalles;
	}
