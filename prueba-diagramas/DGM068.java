...
public class DGM068 {
	...
	private Integer duracionEnsayo;
	private String unidadTiempoEnsayo;
	private String ensayoDobleCiego;
	...
	public List<DGM068Producto> productos;
	...
	public Integer getDuracionEnsayo() {
		return duracionEnsayo;
	}

	public void setDuracionEnsayo(Integer duracionEnsayo) {
		this.duracionEnsayo = duracionEnsayo;
	}

	public String getUnidadTiempoEnsayo() {
		return unidadTiempoEnsayo;
	}

	public void setUnidadTiempoEnsayo(String unidadTiempoEnsayo) {
		this.unidadTiempoEnsayo = unidadTiempoEnsayo;
	}

	public String getEnsayoDobleCiego() {
		return ensayoDobleCiego;
	}

	public void setEnsayoDobleCiego(String ensayoDobleCiego) {
		this.ensayoDobleCiego = ensayoDobleCiego;
	}
	...
	public List<DGM068Producto> getProductos() {
		return productos;
	}

	public void setProductos(List<DGM068Producto> productos) {
