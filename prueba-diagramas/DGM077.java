...
public class DGM077 {
	...
	private String productoConDiluyente;
	private String productoConDm;
	...
	private String razonSocialAcondicionadora;
	private String paisAcondicionadora;
	private String descripcionPaisAcon;
	private String esReacondicionadora;
	private String origenReacondicionadora;
	private String razonSocialReacondicionadora;
	private String paisReacondicionante;
	private String direccionReacondicionadora;
	private String esFabricanteEncargo;
	private String fabricadoPara;
	private String paisEncargaFabricacion;
	private String bajoLicenciaDe;
	private String paisLicenciante;

	public Long getDgm077Id() {
		return dgm077Id;
	}

	public void setDgm077Id(Long dgm077Id) {
		this.dgm077Id = dgm077Id;
	}
	...
	public String getProductoConDiluyente() {
		return productoConDiluyente;
	}

	public void setProductoConDiluyente(String productoConDiluyente) {
		this.productoConDiluyente = productoConDiluyente;
	}

	public String getProductoConDm() {
		return productoConDm;
	}

	public void setProductoConDm(String productoConDm) {
		this.productoConDm = productoConDm;
	}
	...
	public String getSistemaIdentificacion() {
		return sistemaIdentificacion;
	}

	public void setSistemaIdentificacion(String sistemaIdentificacion) {
		this.sistemaIdentificacion = sistemaIdentificacion;
	}
	...
	public String getRazonSocialAcondicionadora() {
		return razonSocialAcondicionadora;
	}

	public void setRazonSocialAcondicionadora(String razonSocialAcondicionadora) {
		this.razonSocialAcondicionadora = razonSocialAcondicionadora;
	}
	...
	public String getDescripcionPaisAcon() {
		return descripcionPaisAcon;
	}

	public void setDescripcionPaisAcon(String descripcionPaisAcon) {
		this.descripcionPaisAcon = descripcionPaisAcon;
	}
	...
	public String getRazonSocialReacondicionadora() {
		return razonSocialReacondicionadora;
	}

	public void setRazonSocialReacondicionadora(String razonSocialReacondicionadora) {
		this.razonSocialReacondicionadora = razonSocialReacondicionadora;
	}

	public String getPaisReacondicionante() {
		return paisReacondicionante;
	}

	public void setPaisReacondicionante(String paisReacondicionante) {
		this.paisReacondicionante = paisReacondicionante;
	}

	public String getDireccionReacondicionadora() {
		return direccionReacondicionadora;
	}

	public void setDireccionReacondicionadora(String direccionReacondicionadora) {
		this.direccionReacondicionadora = direccionReacondicionadora;
	}
	...
	public String getFabricadoPara() {
		return fabricadoPara;
	}

	public void setFabricadoPara(String fabricadoPara) {
		this.fabricadoPara = fabricadoPara;
	}

	public String getPaisEncargaFabricacion() {
		return paisEncargaFabricacion;
	}

	public void setPaisEncargaFabricacion(String paisEncargaFabricacion) {
		this.paisEncargaFabricacion = paisEncargaFabricacion;
	}
